...
namespace EyeXFramework
{
    ...
    public partial class EyeXHost : IDisposable
    {
        ...
        /// This will trigger Activation Focus Changed events to be raised for the interactor 
        /// the user is looking at/no longer looking at.
        /// <remarks>This will be ignored if the engine is already in panning mode.</remarks>
        /// </summary>
        ...
        /// <summary>
        /// Trigger a request that the engine changes to panning mode.
        /// </summary>
        ...
        /// <summary>
        /// Trigger a request that the engine leaves panning mode.
        /// </summary>
