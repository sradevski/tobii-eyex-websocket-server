...
namespace EyeXFramework.Wpf
{
    ...
    public static class WpfCrawler
    {
        ...
        /// <summary>
        /// Gets the first child of the specified type in the provided <see cref="DependencyObject"/>.
        /// </summary>
        ...
        internal static T GetFirstChildOfType<T>(FrameworkElement dependencyObject)
