...
namespace EyeXFramework.Wpf
{
    ...
    public class WpfInteractor
    {
        ...
        /// <summary>
        /// Gets the behavior matching the specified <see cref="BehaviorType"/>.
        /// </summary>
        /// <param name="behaviorType">The <see cref="BehaviorType"/> to query for.</param>
        /// <returns>The <see cref="IEyeXBehavior"/> or <c>null</c> if not found.</returns>
        internal IEyeXBehavior GetBehavior(BehaviorType behaviorType)
        {
            return _behaviors.FirstOrDefault(x => x.BehaviorType == behaviorType);
        }
